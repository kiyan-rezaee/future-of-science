...
###############################################
# My Function   : Fetches article data for a range of years using threads and saves JSON files.
...
###############################################
# My Function   : Main function to start multiple threads for fetching data for different years
# Input         : None
